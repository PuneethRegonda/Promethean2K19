...
class _IntroScreensState extends State<IntroScreens> {
  ...
  List<String> description = [
    ...
    "Different Departments have come forward to conduct various interesting events under the tree of Promethean2K19. Interested people can register in our app and the event registration fee will be collected by our concerned co-ordinators.",
    "Important notices are provided as Alerts.",
    "Location tells you where exactly we are.",
    "We update you with Winner notifications and Event notifications Daily.",
  ];
