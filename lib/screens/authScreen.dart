      ...
      FirebaseAuth.instance
        ...
        if (E.toString().contains(
          ...
          _scaffoldKey.currentState.showSnackBar(SnackBar(
            content: Text(
                "Something went Wrong, please check your device network connection"),
          ));
        return;
      }).then((user) {
        if (user != null) {
          ...
          _scaffoldKey.currentState.showSnackBar(SnackBar(
            content: Text("Something thing went wrong"),
          ));
          return null;
        }
      });
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Text(
                        "Welcome to biggest Annual Technical Symposium of BVRIT",
                        textAlign: TextAlign.center,
                        style: TextStyle(
                            fontFamily: 'QuickSand',
                            fontSize: 19.0,
